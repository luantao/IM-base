...
// Note that use of DefaultHelper methods assumes that DefaultParameters were
// used for extension negotiation during WebSocket handshake.
func CompressFrame(f imws.Frame) (imws.Frame, error) {
...
// Note that use of DefaultHelper methods assumes that DefaultParameters were
// used for extension negotiation during WebSocket handshake.
func CompressFrameBuffer(buf Buffer, f imws.Frame) (imws.Frame, error) {
...
// Note that use of DefaultHelper methods assumes that DefaultParameters were
// used for extension negotiation during WebSocket handshake.
func DecompressFrame(f imws.Frame) (imws.Frame, error) {
...
// Note that use of DefaultHelper methods assumes that DefaultParameters were
// used for extension negotiation during WebSocket handshake.
func DecompressFrameBuffer(buf Buffer, f imws.Frame) (imws.Frame, error) {
...
func (h *Helper) CompressFrame(in imws.Frame) (f imws.Frame, err error) {
...
func (h *Helper) DecompressFrame(in imws.Frame) (f imws.Frame, err error) {
	var buf bytes.Buffer
...
func (h *Helper) CompressFrameBuffer(buf Buffer, f imws.Frame) (imws.Frame, error) {
	if !f.Header.Fin {
...
// Returned frame's payload holds bytes returned by buf.Bytes().
func (h *Helper) DecompressFrameBuffer(buf Buffer, f imws.Frame) (imws.Frame, error) {
	if !f.Header.Fin {
		return f, fmt.Errorf(
