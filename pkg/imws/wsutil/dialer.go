...
// DebugDialer is a wrapper around imws.Dialer. It tracks i/o of WebSocket
...
func (d *DebugDialer) Dial(ctx context.Context, urlstr string) (conn net.Conn, br *bufio.Reader, hs imws.Handshake, err error) {
