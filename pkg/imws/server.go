...
func Upgrade(conn net.Conn) (Handshake, error) {
...
type Upgrader struct {
	...
	OnAuth func(key, value []byte) (uid int64, err error)
}
...
func (u Upgrader) Upgrade(conn net.Conn) (hs Handshake, err error) {
